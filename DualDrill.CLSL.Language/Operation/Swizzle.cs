...
public static class Swizzle
{
        ...
        where TSelf : ISizedComponent<TRank, TSelf>
    {
        ...
        ISizedPattern<TRank> ISizedComponent<TRank>.WithComponent<TC>() => Pattern<TRank, TSelf, TC>.Instance;
        ...
        where TSelf : ISizedPattern<TRank, TSelf>
    {
        ...
        TResult ISizedPattern<TRank>.Accept<TResult>(ISizedPatternVisitor<TResult> visitor) => visitor.Visit<TSelf>();
    }
