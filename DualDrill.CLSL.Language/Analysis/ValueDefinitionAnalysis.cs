    ...
    : IRegionTreeFoldSemantic<Label, ShaderRegionBody, IEnumerable<IShaderValue>, IEnumerable<IShaderValue>>
{
    ...
    public IEnumerable<IShaderValue> Call(IShaderValue result, FunctionDeclaration f,
        IReadOnlyList<IShaderValue> arguments) => [result];

    public IEnumerable<IShaderValue> Dup(IShaderValue result, IShaderValue source) => [result];

    public IEnumerable<IShaderValue> Get(IShaderValue result, IShaderValue source) => [result];
