...
public sealed record class PtrType(IShaderType BaseType, IAddressSpace AddressSpace) : IPtrType, IShaderType<PtrType>
{
    ...
    public T Evaluate<T>(IShaderTypeSemantic<T, T> semantic) => semantic.PtrType(this);

    public static PtrType Instance => throw new NotImplementedException();
}

internal sealed class SingletonPtrType<TBaseType> : IPtrType, ISingleton<SingletonPtrType<TBaseType>>,
...
internal sealed class SingletonPtrType<TBaseType, TAddressSpace>
    : IPtrType
