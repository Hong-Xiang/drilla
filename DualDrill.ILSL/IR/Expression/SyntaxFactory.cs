...
public static class SyntaxFactory
{
    ...
    public static IExpression Literal(float value) => new LiteralValueExpression(new FloatLiteral<N32>(value));
    public static IExpression Literal(int value) => new LiteralValueExpression(new IntLiteral<N32>(value));
    public static IExpression Literal(uint value) => new LiteralValueExpression(new UIntLiteral<N32>(value));
