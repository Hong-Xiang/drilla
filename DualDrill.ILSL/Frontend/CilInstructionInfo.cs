...
public readonly record struct CilInstructionInfo(int Index, int ByteOffset, int NextByteOffset, Instruction Instruction)
{
        ...
        ISymbolTableView table)
    {
        ...
        return Instruction.OpCode.ToILOpCode() switch
        {
            ...
            ILOpCode.Ldind_i4 => visitor.VisitLoadIndirect<IntType<N32>>(this),
            ILOpCode.Ldind_u4 => visitor.VisitLoadIndirect<UIntType<N32>>(this),
            ...
            ILOpCode.Stind_i4 => visitor.VisitStoreIndirect<IntType<N32>>(this),
            ...
            ILOpCode.Initobj => visitor.VisitInitObject(this,
                (Type)instruction.Operand,
                table[(Type)instruction.Operand] ?? throw new KeyNotFoundException()),
