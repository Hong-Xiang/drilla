    ...
    : ICilInstructionVisitor<Unit>
{
    ...
    private void DoStore(IShaderValue target, IShaderValue value)
    {
    ...
    private IUnaryExpressionOperation? ConvertToCilStackTypeOperation(IShaderType type)
    {
        return type switch
        {
    ...
    private IShaderValue EvalExpr2(Func<IShaderType, IShaderType, IBinaryExpressionOperation> parseOp)
    {
        var r = Pop();
        var l = Pop();
    ...
    private void DoLoad(IShaderValue p)
    {
    ...
    private void VisitCallFunction(FunctionDeclaration func, bool hasReturnValue)
    {
    ...
    private IBinaryExpressionOperation BinaryRelationalOperation<TOp>(IShaderType l, IShaderType r, bool isUn)
        where TOp : BinaryRelational.IOp<TOp>
    {
