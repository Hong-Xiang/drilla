...
public sealed partial class N1 : INat<N1>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N1>(Instance);
}
...
public sealed partial class N2 : INat<N2>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N2>(Instance);
}
...
public sealed partial class N3 : INat<N3>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N3>(Instance);
}
...
public sealed partial class N4 : INat<N4>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N4>(Instance);
}
...
public sealed partial class N8 : INat<N8>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N8>(Instance);
}
...
public sealed partial class N16 : INat<N16>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N16>(Instance);
}
...
public sealed partial class N32 : INat<N32>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N32>(Instance);
}
...
public sealed partial class N64 : INat<N64>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N64>(Instance);
}
...
public sealed partial class N128 : INat<N128>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N128>(Instance);
}
...
public sealed partial class N256 : INat<N256>
{
	...
	public T Accept<T>(INatVisitor<T> visitor) => visitor.Visit<N256>(Instance);
}
...
public static partial class Nat {
	...
	public static INat GetInstance<TNat>() {
		return typeof(TNat) switch {
			var t when t == typeof(N1) => N1.Instance,
			var t when t == typeof(N2) => N2.Instance,
			var t when t == typeof(N3) => N3.Instance,
			var t when t == typeof(N4) => N4.Instance,
			var t when t == typeof(N8) => N8.Instance,
			var t when t == typeof(N16) => N16.Instance,
			var t when t == typeof(N32) => N32.Instance,
			var t when t == typeof(N64) => N64.Instance,
			var t when t == typeof(N128) => N128.Instance,
			var t when t == typeof(N256) => N256.Instance,
