...
public partial struct vec4i32{
    ...
    public static vec4i32 operator %(vec4i32 left, vec4i32 right)
    {
        return vec4((Int32)(left.x % right.x), (Int32)(left.y % right.y), (Int32)(left.z % right.z), (Int32)(left.w % right.w));
    }
    ...
    public static vec4i32 operator %(Int32 left, vec4i32 right)
    {
        return vec4((Int32)(left % right.x), (Int32)(left % right.y), (Int32)(left % right.z), (Int32)(left % right.w));
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static vec4i32 operator %(vec4i32 left, Int32 right)
    {
        return vec4((Int32)(left.x % right), (Int32)(left.y % right), (Int32)(left.z % right), (Int32)(left.w % right));
    }
