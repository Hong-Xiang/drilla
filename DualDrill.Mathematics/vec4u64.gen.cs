...
public partial struct vec4u64{
    ...
    public static vec4u64 operator %(vec4u64 left, vec4u64 right)
    {
        return vec4((UInt64)(left.x % right.x), (UInt64)(left.y % right.y), (UInt64)(left.z % right.z), (UInt64)(left.w % right.w));
    }
    ...
    public static vec4u64 operator %(UInt64 left, vec4u64 right)
    {
        return vec4((UInt64)(left % right.x), (UInt64)(left % right.y), (UInt64)(left % right.z), (UInt64)(left % right.w));
    }
    
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static vec4u64 operator %(vec4u64 left, UInt64 right)
    {
        return vec4((UInt64)(left.x % right), (UInt64)(left.y % right), (UInt64)(left.z % right), (UInt64)(left.w % right));
    }
