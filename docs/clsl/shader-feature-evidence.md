...
> [Writable f32 structured buffers](./writable-structured-buffer.md). Current
> strict vertex `instance_index` support is documented in
> [Vertex instance index](./instance-index.md); the historical rejection
> capture below remains attributed to the stated baseline.
