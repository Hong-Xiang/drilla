...
//public sealed class RTCDataChannelProxy(IBrowserClient Client, IJSObjectReference Value) : IAsyncDisposable
//{
...
//   RTCDataChannelProxy Target) : IAsyncDisposable
//{
//    public RTCDataChannelProxy Source { get; } = Source;

//    public RTCDataChannelProxy Target { get; } = Target;
...
//    public static async Task<RTCDataChannelPair> CreateAsync(RTCPeerConnectionPair peers, string label)
//    {
